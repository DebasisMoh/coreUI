...
//	}
	...
	public static String captureScreenshot(WebDriver driver) throws IOException {
		...
		String destinatino = "D:\\automationAtEsspl\\coreUI\\Screenshots\\"+currentdateandtime()+".png";//System.getProperty("user.dir")+"\\Reports\\"+currentdateandtime()+".png";//cnfgProp.getProperty("reportPath")+"/extentReport.html";
		File targte = new File(destinatino);System.out.println(destinatino);System.out.println("--------------------destntn-----------------");
